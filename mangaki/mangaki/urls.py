...
urlpatterns = patterns('',
    ...
    #url(r'^getuser/(?P<work_id>\w+)/(?P<target_id>\w+)\.json$', 'mangaki.views.get_user_for_recommendations'),
    #url(r'^recommend/(?P<work_id>\w+)/(?P<target_id>\w+)\.json$', 'mangaki.views.recommend_work'),
