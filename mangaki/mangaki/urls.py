...
urlpatterns = patterns('',
    ...
    url(r'^artist/(?P<artist_id>\d+)$', AnimeList.as_view()),
    url(r'^artist/(?P<artist_id>\d+)/add/(?P<work_id>\d+)$', 'mangaki.views.add_pairing'),
    ...
    url(r'^newsletter/$', 'mangaki.views.update_newsletter'),
