...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Manga',
            fields=[
                ('work_ptr', models.OneToOneField(parent_link=True, auto_created=True, to='mangaki.Work', primary_key=True, serialize=False)),
                ...
                ('mangaka', models.ForeignKey(related_name='drew', to='mangaki.Artist')),
                ('writer', models.ForeignKey(related_name='wrote', to='mangaki.Artist')),
            ],
            options={
            },
            bases=('mangaki.work',),
